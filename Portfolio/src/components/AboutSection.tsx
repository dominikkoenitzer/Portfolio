          ...
          <div className="relative mx-auto max-w-xs md:max-w-none">
            <div className="aspect-square rounded-2xl overflow-hidden shadow-lg bg-background/80">
              <div className="w-full h-full bg-gradient-to-br from-primary/10 via-primary/5 to-transparent flex items-center justify-center">
                <motion.img 
                  src="https://github.com/Punds101/Punds/blob/main/Punds-Frontend/public/Favicon.png?raw=true"
          ...
          >
            ...
            <div className="space-y-4 sm:space-y-5">
              <motion.p 
                ...
                viewport={{ once: true }}
              >
                I'm Dominik Könitzer, a 17-year-old software engineer at WISS Schulen für Wirtschaft Informatik Immobilien, currently in my fourth semester of a 4-year software engineering program. I started on August 21, 2023, and will complete it on July 31, 2027.
              </motion.p>
