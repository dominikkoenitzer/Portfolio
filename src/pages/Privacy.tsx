  ...
  return (
    <>
      <SEO
        ...
        description="Privacy policy for dk.punds.ch. Learn how your data is collected, used, and protected when visiting this website. Compliant with Swiss FADP and EU GDPR regulations."
              ...
              <div className="space-y-8">
                <section>
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    This personal portfolio website (<a href="https://dk.punds.ch" className="text-primary hover:underline">https://dk.punds.ch</a>) showcases my projects and freelance services. This privacy policy complies with the Swiss Federal Act on Data Protection (revFADP 2023) and the European General Data Protection Regulation (GDPR). It explains which data are processed when you visit this site and why.
                  </p>
                ...
                <section>
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    This privacy policy may be updated to reflect changes in law or site functionality. The current version is always available at: <a href="https://dk.punds.ch/privacy" className="text-primary hover:underline">https://dk.punds.ch/privacy</a>
                  </p>
                </section>
