...
export const HOME_FAQS: LocaleRecord<FAQItem[]> = {
  en: [
    ...
    },
    {
      ...
      answer:
        "You can contact Dominik Könitzer through the contact form on this website at dk.punds.ch/contact. He is available for freelance work, collaborations, and consulting opportunities in software engineering and web development.",
    },
    {
  ...
  de: [
    ...
    },
    {
      ...
      answer:
        "Du kannst Dominik Könitzer über das Kontaktformular auf dieser Website unter dk.punds.ch/contact erreichen. Er ist für Freelance-Aufträge, Kollaborationen und Beratungsprojekte im Software-Engineering und in der Webentwicklung verfügbar.",
    },
    {
  ...
  fr: [
    ...
    },
    {
      ...
      answer:
        "Vous pouvez contacter Dominik Könitzer via le formulaire de contact de ce site à dk.punds.ch/contact. Il est disponible pour du freelance, des collaborations et des missions de conseil en ingénierie logicielle et en développement web.",
    },
    {
  ...
  zh: [
    ...
    },
    {
      ...
      answer:
        "您可以通过本网站的联系表单 dk.punds.ch/contact 与 Dominik Könitzer 联系。他可承接自由职业、合作项目以及软件工程与网页开发方面的咨询机会。",
    },
    {
...
export const SERVICES_HOW_TO: LocaleRecord<HowToSchema> = {
  en: {
    ...
    step: [
      ...
      },
      {
        ...
        text: "Use the contact form at dk.punds.ch/contact to discuss your project requirements, timeline, and budget. Provide details about your current website or software needs.",
      },
      {
  ...
  de: {
    ...
    step: [
      ...
      },
      {
        ...
        text: "Nutze das Kontaktformular unter dk.punds.ch/contact, um deine Projektanforderungen, deinen Zeitplan und dein Budget zu besprechen. Beschreibe deine aktuellen Website- oder Software-Anforderungen.",
      },
      {
  ...
  fr: {
    ...
    step: [
      ...
      },
      {
        ...
        text: "Utilisez le formulaire de contact sur dk.punds.ch/contact pour discuter de vos besoins, du calendrier et du budget. Précisez vos besoins actuels en site web ou en logiciel.",
      },
      {
  ...
  zh: {
    ...
    step: [
      ...
      {
        name: "联系咨询",
        text: "通过 dk.punds.ch/contact 上的联系表单沟通您的项目需求、时间安排与预算。请详细描述您现有的网站或软件需求。",
      },
      {
        name: "获取方案",
