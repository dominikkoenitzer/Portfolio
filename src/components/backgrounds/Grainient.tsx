...
// Keep renderer/program alive across re-renders so the prop-sync effect can
// update uniforms without ever rebuilding the WebGL context.
...
const Grainient = ({
  ...
  return (
    <div className={`grainient-container ${className}`.trim()} ref={containerRef} />
  );
};
