...
const frontendIcon = (
  <svg className="lucide lucide-layout" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
...
const professionalIcon = (
  <svg className="lucide lucide-briefcase" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
    <rect height="14" rx="2" ry="2" width="20" x="2" y="7" />
    <path d="M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16" />
  </svg>
);
const backendIcon = (
  <svg className="lucide lucide-server" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
...
const devopsIcon = (
  <svg className="lucide lucide-terminal" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
    <polyline points="4 17 10 11 4 5" />
    <line x1="12" x2="20" y1="19" y2="19" />
  </svg>
);
const databasesIcon = (
  <svg className="lucide lucide-database" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
...
const languagesIcon = (
  <svg className="lucide lucide-languages" fill="none" height="24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
    <path d="m5 8 6 6" />
...
const skillCategories: SkillCategory[] = [
  ...
  },
  {
    ...
    skills: [
      { name: "Customer Service", descKey: "customerService", proficiency: 90 },
      { name: "Communication", descKey: "communication", proficiency: 90 },
      { name: "Project Management", descKey: "projectManagement", proficiency: 85 },
      { name: "Microsoft Excel", descKey: "excel", proficiency: 85 },
      { name: "Direct Sales", descKey: "directSales", proficiency: 80 },
      { name: "Social Media Outreach", descKey: "socialMedia", proficiency: 80 },
