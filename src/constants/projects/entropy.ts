...
export const entropy: Record<Language, LocalizedContent> = {
  en: {
    tagline: "Real randomness and an honest strength score, with nothing ever leaving your browser.",
    description:
    ...
    objectives: [
      ...
      "Generate, score, and tune in one flow, without copy-pasting between tools.",
    ],
    ...
    implementationHighlights: [
      ...
      "Custom rules for length, character sets, and constraints that stay usable instead of becoming a maze.",
    ],
    qualityAndSecurity: [
    ...
    hiringSignals: [
      "I reach for the right primitive, CSPRNG instead of Math.random(), and ship it in a real product.",
  ...
  de: {
    tagline: "Echte Zufälligkeit und eine ehrliche Stärke-Bewertung, ohne dass etwas deinen Browser verlässt.",
    description:
    ...
    objectives: [
      ...
      "Generieren, bewerten und feinjustieren in einem Flow, ohne Kopieren zwischen Tools.",
    ],
    architectureDecisions: [
    ...
    implementationHighlights: [
      ...
      "Eigene Regeln für Länge, Zeichensätze und Einschränkungen, die nutzbar bleiben statt zum Labyrinth zu werden.",
    ],
    qualityAndSecurity: [
    ...
    impactPoints: [
      ...
      "Erklärt in klaren Worten, warum ein Passwort schwach ist.",
  ...
  fr: {
    tagline: "Du vrai aléa et un score de robustesse honnête, sans que rien ne quitte votre navigateur.",
    description:
    ...
    objectives: [
      ...
      "Générer, évaluer et ajuster dans un seul flux, sans copier-coller entre outils.",
    ],
    architectureDecisions: [
    ...
    implementationHighlights: [
      ...
      "Des règles personnalisées de longueur, de jeux de caractères et de contraintes, qui restent utilisables au lieu de devenir un labyrinthe.",
    ],
    qualityAndSecurity: [
    ...
    impactPoints: [
      ...
      "Explique en mots clairs pourquoi un mot de passe est faible.",
  ...
  zh: {
    tagline: "真正的随机性和诚实的强度评分，而且没有任何东西离开你的浏览器。",
    description:
