...
export const zephyr: Record<Language, LocalizedContent> = {
  en: {
    tagline: "A to-do list and a focus timer — all yours, all offline.",
    description:
  ...
  de: {
    tagline: "Eine To-do-Liste und ein Fokus-Timer — alles deins, alles offline.",
    description:
    ...
    overview:
      "Ich habe Zephyr gebaut, weil jede Produktivitäts-App ein Konto will, ein Abo und eine Kopie deines ganzen Tages auf fremden Servern. Also schrieb ich meine eigene — mit React, Vite, Tailwind und Radix — und legte jede Aufgabe und jede Fokus-Session in den localStorage. Nichts wird hochgeladen, nichts zum Anmelden, und es läuft auch mit ausgeschaltetem WLAN. Früher trug es auch Notizen, ein Journal und einen Kalender; ich habe sie gestrichen, damit die zwei Tools, die täglich gebraucht werden, schnell und klar bleiben.",
  ...
  fr: {
    tagline: "Une liste de tâches et un minuteur de focus — tout à vous, tout hors ligne.",
    description:
    ...
    overview:
      "J'ai construit Zephyr parce que chaque app de productivité veut un compte, un abonnement et une copie de toute votre journée sur le serveur d'un autre. Alors j'ai écrit la mienne — en React, Vite, Tailwind et Radix — et j'ai mis chaque tâche et chaque session de focus dans le localStorage. Rien n'est envoyé, rien à créer comme compte, et ça marche même le Wi-Fi coupé. Elle a aussi porté des notes, un journal et un calendrier ; je les ai retirés pour que les deux outils utilisés chaque jour restent rapides et évidents.",
  ...
  zh: {
    tagline: "一份待办清单，一个专注计时器——全归你，全离线。",
    description:
