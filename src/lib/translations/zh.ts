export const zh = {
  ...
  about: {
    ...
    intro2Before: "大多数时候，你会看到我开着太多标签页，咖啡放凉了，还对一个偏了两像素的按钮很有意见。我喜欢快、好看、",
    intro2Highlight: "就是能用",
    intro2After:
      "的东西。那种你根本不用去想它的东西。我今年 18 岁，也就是说这事我从还只是爱好的时候就在做了。",
    intro3Before: "合上笔记本的时候，我多半正第一百次在折腾我的电脑主题、在看动画，或者在为字体跟人争论。如果你的网站需要一点爱，或者只是想打个招呼，",
