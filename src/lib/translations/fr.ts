export const fr = {
  ...
  seo: {
    ...
    privacy: {
      title: "Politique de confidentialité",
      description:
        "Politique de confidentialité pour dk.punds.ch. Découvrez comment vos données sont collectées, utilisées et protégées lorsque vous visitez ce site. Conforme à la LPD suisse et au RGPD de l'UE.",
      keywords:
