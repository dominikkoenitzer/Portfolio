export const fr = {
  ...
  search: {
    ...
    placeholder: "Chercher pages, projets, services…",
  ...
  about: {
    ...
    cards: {
      ...
      languagesSubtitle: "Allemand, anglais, mandarin",
    },
  },
  skills: {
  ...
  projects: {
    ...
    toolbarLabel: "Filtrer et trier les projets",
    ...
    sortAZ: "A–Z",
    showingCount: "{count} sur {total}",
    noResultsTitle: "Aucun résultat",
    noResultsQuery: "Recherche : « {query} »",
    noResultsBody:
      "Aucun projet ne correspond à cette recherche. Essayez un autre mot-clé ou réinitialisez les filtres.",
  ...
  projectDetails: {
    ...
    timeline: "Période",
    gallery: "Galerie",
    viewImage: "Ouvrir l’image {index} sur {total} en grand",
    imageCounter: "{index} sur {total}",
