export const en = {
  ...
  seo: {
    ...
    privacy: {
      title: "Privacy Policy",
      description:
        "Privacy policy for dk.punds.ch. Learn how your data is collected, used, and protected when visiting this website. Compliant with Swiss FADP and EU GDPR regulations.",
      keywords:
        "privacy policy, data protection, GDPR, FADP, privacy statement, data privacy, Switzerland privacy",
    },
    projectDetailsKeywordsSuffix:
      "project, software engineering case study, web development portfolio",
  },
} as const;
