export const en = {
  ...
  projects: {
    ...
    toolbarLabel: "Filter and sort projects",
    ...
    noResultsQuery: "Searched for “{query}”",
    noResultsBody:
      "No project matches that search. Try a different keyword, or reset the filters.",
  ...
  projectDetails: {
    ...
    timeline: "Timeline",
    gallery: "Gallery",
    viewImage: "Open image {index} of {total} at full size",
    imageCounter: "{index} of {total}",
